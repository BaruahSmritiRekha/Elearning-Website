...
$_SESSION["comment_category"] = "image";
                    ...
                    <nav class="blog-pagination justify-content-center d-flex">
                        <ul class="pagination">
                            <li class="page-item">
                                ...
                                ?>
                            <li class="page-item" ><a href="image_posts.php?page=<?php echo $previous_page?>" class="page-link"> Previous </a></li>
                            ...
                            {    //for loop start
                                ...
                                <li class="page-item <?php echo "$isClicked" ?>"><a href="image_posts.php?page=<?php echo $page?>" class="page-link"><?php echo $page ?> </a></li>
                            ...
                            ?>
                            <li class="page-item"><a href="image_posts.php?page=<?php echo $next_page?>" class="page-link"> Next </a></li>
