    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 course_details_left">
                    ...
                    <h4 class="title" style="text-decoration: underline;pt-4px">pdfs</h4>
                    <div class="content">
                        <ul class="course_list">
                            ...
                            {
                                echo "Search result not saved";
                            }

                            $query="SELECT * FROM pdf where pdf_tags LIKE '%$search%'";
                            ...
                            else
                            {
                                ...
                                $query="SELECT * FROM pdf where pdf_tags LIKE '%$search%' LIMIT ".$page_starting_limit_number.','.$results_per_page;
                                $result = mysqli_query($con,$query);
                    ...
                    <nav class="blog-pagination justify-content-center d-flex">
                        <ul class="pagination">
                            <li class="page-item">
                                ...
                                ?>
                            <li class="page-item" ><a href="pdf_posts_search2.php?page=<?php echo $previous_page?>" class="page-link"> Previous </a></li>
                            ...
                            {    //for loop start
                                ...
                                <li class="page-item <?php echo "$isClicked" ?>"><a href="pdf_posts_search2.php?page=<?php echo $page?>" class="page-link"><?php echo $page ?> </a></li>
                            ...
                            ?>
                            <li class="page-item"><a href="pdf_posts_search2.php?page=<?php echo $next_page?>" class="page-link"> Next </a></li>
