...
$_SESSION["comment_category"] = "video";
        ...
        <nav class="blog-pagination justify-content-center d-flex">
            <ul class="pagination">
                ...
                {    //for loop start
                    ...
                    <li class="page-item <?php echo "$isClicked" ?>"><a href="video_post.php?page=<?php echo $page?>" class="page-link"><?php echo $page ?> </a></li>
                ...
                ?>
                <li class="page-item"><a href="video_post.php?page=<?php echo $next_page?>" class="page-link"> Next </a></li>
